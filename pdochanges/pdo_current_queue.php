...
/***********************************************************************************************************/
#TODO Things before moving to production
/* 1. Remove the $debug760 and print statements
   2. Change the links in the order by to current_queue.php instead of pdo_current_queue.php
   3. Remove  
        #$stmt->debugDumpParams();
   4. Change pdo_ scripts to actual script names
*/
#TODO


session_start();
include('pdo_cluster_support_lib.php');
include('pdo_state_history_lib.php');
include('config.php');
...
<div id="content" class="narrowcolumn">
     ...
     <p><a href="/about/queue/">[About this page]</a>&nbsp;&nbsp;<a href="/reports/CurrQstats.txt">[Summary statistics]</a>&nbsp;&nbsp;<a href="/pdo_all_clusters.php">[List of all active clusters]</a></p>
<?php
#print "<table class=\"format_status\">\n";
print '<div class="scrolltable">';
print "<table class=\"dynamictable\">\n";
print "<tr>\n";
#TODO change later to current queue
print "<th><a href=\"pdo_current_queue.php?sortkey=1&sorting=$sort\">Current state</a></th>";
print "<th><a href=\"pdo_current_queue.php?sortkey=2&sorting=$sort\">Weeks in state</a></th>";
print "<th><a href=\"pdo_current_queue.php?sortkey=3&sorting=$sort\">Weeks in queue</a></th>";
print "<th><a href=\"pdo_current_queue.php?sortkey=4&sorting=$sort\">Draft name (Authors)</a></th>";
print "<th> <a href=\"pdo_current_queue.php?sortkey=5&sorting=$sort\">Cluster</a></th>";
print "<th><a href=\"pdo_current_queue.php?sortkey=6&sorting=$sort\">Pages</a></th>";
print "<th><a href=\"pdo_current_queue.php?sortkey=7&sorting=$sort\">Submitted</a></th>";
#TODO
print "</tr>\n";
